        ...
        return Stack(
          children: [
            ...
            _buildNebula(
              ...
              color: const Color(0xFF004D40).withOpacity(0.6), // cite: 1
              size: 400,
            ),
            ...
            _buildNebula(
              ...
              color: const Color(0xFF827717).withOpacity(0.4), // cite: 1
              size: 500,
            ),
            ...
            _buildNebula(
              ...
              color: const Color(0xFF310000).withOpacity(0.7), // cite: 1
              size: 600,
            ),
                                ...
                                Positioned.fill(
                                  child: CustomPaint(
                                    painter: WaterWavePainter(
                                      ...
                                      const Color(0xFF004D40).withOpacity(0.2), // Onda esmeralda sutil // cite: 1
                                    ),
                                  ),
                                ),
                                Text(
                                  ...
                                  style: TextStyle(
                                    color: Colors.white.withOpacity(0.9), // cite: 1
                                    fontSize: 17,
                          ...
                          Transform.scale(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: _isExpanded
                                    ? Colors.white.withOpacity(0.85) // Barra clara para texto negro // cite: 1
                                    : Colors.white.withOpacity(0.1), // cite: 1
                                boxShadow: [
                                  if (!_isExpanded)
                                    BoxShadow(
                                      color: Colors.white.withOpacity(15 / 255.0), // cite: 1
                                      blurRadius: 15,
                                    ...
                                    if (_isExpanded)
                                      Positioned.fill(
                                        child: CustomPaint(
                                          painter: WaterWavePainter(
                                            _waveController.value,
                                            Colors.black.withOpacity(0.05), // cite: 1
                                          ),
                                        ),
                                      ),
                                    if (!_isExpanded)
                                      Center(
                                        child: CustomPaint(
                                          painter: MorphingBlobPainter(
                                            _waveController.value,
                                            _isThinking // cite: 1
                                                ? Colors.white.withOpacity(0.5) // cite: 1
                                                : Colors.white.withOpacity(0.2), // cite: 1
                                            _isThinking,
                                          ),
