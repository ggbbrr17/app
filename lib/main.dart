      ...
      return Container(
        ...
        child: Center(
          child: SingleChildScrollView(
            child: Text(
              "⚠️ GLYPH ERROR:\n\n${details.exception}",
              style: const TextStyle(color: Colors.redAccent, decoration: TextDecoration.none, fontSize: 13, fontFamily: 'monospace'),
        ...
        builder: (context, child) {
          ...
          return Stack(
            children: [
              ...
              Container(color: Colors.black.withOpacity(0.1)), // Filtro oscuro más suave
            ],
          );
        },
      ),
...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin, WidgetsBindingObserver {
  ...
  Future<void> _initializeNotifications() async {
    ...
    // Solicitar permisos explícitamente después de inicializar
