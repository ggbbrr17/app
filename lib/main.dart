...
class PixelFieldPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      final color = Color.lerp(base, alt, mix)!.withValues(alpha: alpha / 255.0);
                        ...
                        child: Opacity(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                  if (!_isExpanded) BoxShadow(color: Colors.white.withValues(alpha: 0.06), blurRadius: 15, spreadRadius: pulse * 2),
