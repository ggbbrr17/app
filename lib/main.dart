      ...
      builder: (context, child) {
        return Stack(
          children: [
            ...
            // Luz Verde Esmeralda
            _buildNebula(
              alignment: Alignment(-0.8, -0.2 + math.sin(animation.value * 2 * math.pi) * 0.2),
            ...
            // Luz Ocre Cálido
            _buildNebula(
              alignment: Alignment(0.7, 0.4 + math.cos(animation.value * 2 * math.pi) * 0.3),
              color: const Color(0xFF827717).withValues(alpha: 0.4),
              size: 500,
            ),
            
            // Luz Carmesí Oscuro
            _buildNebula(
              alignment: Alignment(0.0, 0.9 + math.sin(animation.value * 2 * math.pi) * 0.1),
              color: const Color(0xFF310000).withValues(alpha: 0.7),
              size: 600,
            ),
                                ...
                                Positioned.fill(
                                  child: CustomPaint(
                                    painter: WaterWavePainter(
                                      ...
                                      const Color(0xFF004D40).withValues(alpha: 0.2), // Onda esmeralda sutil
                                    ),
                                  ),
                                ),
                                Text(
                          ...
                          Transform.scale(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: _isExpanded
                                    ? Colors.white.withValues(alpha: 0.85) // Barra clara para texto negro
