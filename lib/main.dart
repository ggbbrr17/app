...
void main() {
  debugPrint("🚀 GLYPH: Iniciando motor Dart...");

  // Capturar errores de Flutter (errores de renderizado/UI)
  FlutterError.onError = (details) {
    FlutterError.presentError(details);
    debugPrint('🚨 ERROR FLUTTER: ${details.exception}');
  };

  // Capturar errores de la plataforma/Dart (errores de inicialización)
  ...
  runZonedGuarded(() {
    ...
    // Personalizar la pantalla de error que ve el usuario final
    ...
    // Esto captura errores fuera del ciclo de vida de Flutter
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      radius: 0.8,
                      colors: [const Color(0xFF00FBFF).withValues(alpha: 0.8), const Color(0xFF00FBFF).withValues(alpha: 0)],
                    ),
                  ),
                ),
              ),
              ...
              Align(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      radius: 0.8,
                      colors: [const Color(0xFFCCFF00).withValues(alpha: 0.7), const Color(0xFFCCFF00).withValues(alpha: 0)],
                    ),
                  ),
                ),
              ),

              // TEMPORAL: Desactivamos el Blur para diagnosticar la pantalla negra
              // BackdropFilter(
              //   filter: ImageFilter.blur(sigmaX: 15, sigmaY: 15),
              //   child: Container(color: Colors.transparent),
              // ),
              Container(color: Colors.black.withValues(alpha: 0.3)), // Filtro oscuro ligero
            ],
          );
        },
      ),
