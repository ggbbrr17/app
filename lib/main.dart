                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [const Color(0xFF00FBFF).withOpacity(0.6), const Color(0xFF00FBFF).withOpacity(0)],
                    ),
                  ),
                ),
              ),
              ...
              Align(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    gradient: RadialGradient(
                      colors: [const Color(0xFFCCFF00).withOpacity(0.5), const Color(0xFFCCFF00).withOpacity(0)],
                    ),
                  ),
                ),
              ),
              ...
              Align(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    gradient: RadialGradient(
                      colors: [const Color(0xFFBD00FF).withOpacity(0.55), const Color(0xFFBD00FF).withOpacity(0)],
                    ),
                  ),
                ),
              ),
